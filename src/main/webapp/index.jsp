...
<link rel="stylesheet" src="resources/css/style.css"/>
...
<body>
	<aside
		...
		<ul class="categories list-unstyled">
			...
			<li class=""><i class="uil-folder"></i><a href="#"> File
					manager</a></li>
			...
			<li class=""><i class="uil-setting"></i><a href="#">
					Settings</a>
				<ul class="sidebar-dropdown list-unstyled">
					<li><a href="#">Lorem ipsum</a></li>
					<li><a href="#">ipsum dolor</a></li>
			...
			<li class=""><i class="uil-map-marker"></i><a href="#"> Maps</a>
			</li>
		</ul>
	</aside>
		...
		<div class="p-4">
			<div class="welcome">
				<div class="content rounded-3 p-3">
					...
					<p class="mb-0">Hello Jone Doe, welcome to your awesome
						dashboard!</p>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-4">
						<div
							...
							<i
								class="uil-envelope-shield fs-2 text-center bg-primary rounded-circle"></i>
							<div class="ms-3">
					...
					<div class="col-lg-4">
						<div class="box d-flex rounded-2 align-items-center p-3">
							<i
								class="uil-users-alt fs-2 text-center bg-success rounded-circle"></i>
							<div class="ms-3">
								<div class="d-flex align-items-center">
