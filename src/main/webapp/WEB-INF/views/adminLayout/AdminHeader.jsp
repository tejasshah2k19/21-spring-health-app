...
<!-- theme stylesheet-->
<link rel="stylesheet" href="resources/assets/css/style.default.css"
	id="theme-stylesheet">
			...
			<div class="right-menu list-inline no-margin-bottom">
				...
				<div class="list-inline-item dropdown">
					...
					<div aria-labelledby="navbarDropdownMenuLink1"
						...
						<a href="#"
							...
							<div class="profile">
								<img src="resources/assets/img/avatar-3.jpg" alt="..." class="img-fluid">
							...
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="resources/assets/img/avatar-2.jpg" alt="..." class="img-fluid">
							...
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="resources/assets/img/avatar-1.jpg" alt="..." class="img-fluid">
								<div class="status busy"></div>
							</div>
							<div class="content">
								<strong class="d-block">Sam Kaheil</strong><span class="d-block">lorem
									ipsum dolor sit amit</span><small class="date d-block">6:55am</small>
							</div>
						</a><a href="#"
							class="dropdown-item message d-flex align-items-center">
							<div class="profile">
								<img src="resources/assets/img/avatar-5.jpg" alt="..." class="img-fluid">
								<div class="status offline"></div>
							</div>
							<div class="content">
								<strong class="d-block">Sara Wood</strong><span class="d-block">lorem
									ipsum dolor sit amit</span><small class="date d-block">10:30pm</small>
							</div>
						</a><a href="#" class="dropdown-item text-center message"> <strong>See
				...
				<div class="list-inline-item dropdown">
					...
					<div aria-labelledby="navbarDropdownMenuLink2"
						...
						<a href="#" class="dropdown-item">
							...
							<div class="progress">
								<div role="progressbar" style="width: 40%" aria-valuenow="40"
							...
							<div class="progress">
								<div role="progressbar" style="width: 20%" aria-valuenow="20"
									aria-valuemin="0" aria-valuemax="100"
							...
							<div class="progress">
								<div role="progressbar" style="width: 65%" aria-valuenow="65"
									aria-valuemin="0" aria-valuemax="100"
									class="progress-bar dashbg-1"></div>
							</div>
						</a><a href="#" class="dropdown-item text-center"> <strong>See
								All Tasks <i class="fa fa-angle-right"></i>
						</strong></a>
					</div>
				</div>
				<!-- Tasks end-->
				...
				<div class="list-inline-item dropdown">
					<a id="languages" rel="nofollow" data-target="#" href="#"
						...
						src="resources/assets/img/flags/16/GB.png" alt="English"><span
					...
					<div aria-labelledby="languages" class="dropdown-menu">
						<a rel="nofollow" href="#" class="dropdown-item"> <img
							src="resources/assets/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a
							rel="nofollow" href="#" class="dropdown-item"> <img
							src="resources/assets/img/flags/16/FR.png" alt="English" class="mr-2"><span>French
						</span></a>
					</div>
				</div>
				<!-- Log out               -->
				<div class="list-inline-item logout">
					<a id="logout" href="logout" class="nav-link"> <span
