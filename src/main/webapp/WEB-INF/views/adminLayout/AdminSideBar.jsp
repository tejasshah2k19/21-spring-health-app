...
<div class="d-flex align-items-stretch">
	...
	<nav id="sidebar">
		...
		<div class="sidebar-header d-flex align-items-center">
			<div class="avatar">
				<img src="resources/assets/img/avatar-6.jpg" alt="..."
		...
		<ul class="list-unstyled">
			...
			<li><a href="getallingredients"> <i class="icon-grid"></i>Ingredients
			</a></li>
			...
			<li><a href="#exampledropdownDropdown" aria-expanded="false"
				data-toggle="collapse"> <i class="icon-windows"></i>Example
					dropdown
			</a>
			...
			<li><a href="login.html"> <i class="icon-logout"></i>Login
					page
			</a></li>
		</ul>
